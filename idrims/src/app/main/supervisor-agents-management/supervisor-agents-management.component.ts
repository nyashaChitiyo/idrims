...
@Component({
  selector: 'app-supervisor-agents-management',
  templateUrl: './supervisor-agents-management.component.html',
  styleUrls: ['./supervisor-agents-management.component.css']
})
export class SupervisorAgentsManagementComponent implements OnInit {

...
export class DailyReportComponent implements OnInit {
  ...
  getAll(){
    this.demo.get('http://108.61.174.41:7070/api/reports/view/all/today')
    .subscribe(
      (data:any[])=> { 
        let arr = [];
        arr.push(data)
  ...
  getByCollectionPoint(){
    ...
    this.demo.post('http://108.61.174.41:7070/api/reports/view/all/today/collectionPointId',{
      "id": this.colpointID
    })
    .subscribe(
      (data: Response)=> {
  ...
  getByUserID(){
    this.demo.post('http://108.61.174.41:7070/api/reports/view/all/today/userId',{
      "id": +this.selectedReg
    })
    .subscribe(
      (data: Response)=> {
